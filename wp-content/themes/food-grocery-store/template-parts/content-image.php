          ...
          <?php if( get_theme_mod( 'food_grocery_store_toggle_postdate',true) != '' || get_theme_mod( 'food_grocery_store_toggle_author',true) != '' || get_theme_mod( 'food_grocery_store_toggle_comments',true) != '') { ?>
            <div class="post-info p-2 mb-3">
              <?php if(get_theme_mod('food_grocery_store_toggle_postdate',true)==1){ ?>
                <i class="fas fa-calendar-alt"></i><span class="entry-date"><a href="<?php echo esc_url( get_day_link( $food_grocery_store_archive_year, $food_grocery_store_archive_month, $food_grocery_store_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><span>|</span>
              <?php } ?>
              ...
              <?php if(get_theme_mod('food_grocery_store_toggle_comments',true)==1){ ?>
                <i class="fa fa-comments" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'food-grocery-store'), __('0 Comments', 'food-grocery-store'), __('% Comments', 'food-grocery-store') ); ?></span><span>|</span>
              <?php } ?>
      ...
      <div class="service-text">
        ...
        <?php if( get_theme_mod( 'food_grocery_store_toggle_postdate',true) != '' || get_theme_mod( 'food_grocery_store_toggle_author',true) != '' || get_theme_mod( 'food_grocery_store_toggle_comments',true) != '') { ?>
          <div class="post-info p-2 mb-3">
            ...
            <?php if(get_theme_mod('food_grocery_store_toggle_comments',true)==1){ ?>
              <i class="fa fa-comments" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'food-grocery-store'), __('0 Comments', 'food-grocery-store'), __('% Comments', 'food-grocery-store') ); ?></span>
            <?php } ?>
