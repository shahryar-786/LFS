...
<main id="maincontent" role="main">  
  ...
  <?php if( get_theme_mod( 'food_grocery_store_slider_arrows', false) != '' || get_theme_mod( 'food_grocery_store_resp_slider_hide_show', false) != '') { ?>
    <section id="slider">
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod( 'food_grocery_store_slider_speed',3000)) ?>"> 
